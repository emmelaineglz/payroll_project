...
class FacturaPdfXml extends FPDF {
  ...
  public function HeaderPay($data){
    ...
    public function HeaderG($data, $regPatronal = '') {
      ...
      $this->Cell(40, 4, (!$data[razonSocial]) ? $data[nombreFiscal] : $data[razonSocial], 0, 0, 'L');
      $this->Ln();
      $this->Cell(25, 4, "RFC:", 0, 0, 'L');
      $this->Cell(40, 4, $data[rfc], 0, 0, 'L');
      $this->Cell(25, 4, utf8_decode("Régimen Fiscal:"), 0, 0, 'L');
      $this->Cell(50, 4, ($data[regimenFiscal] === '601') ? "General de Ley Personas Morales" : utf8_decode("Personas Físicas con Actividades"), 0, 0, 'L');
      ...
      $this->Cell(40, 4, (!$data[codigoPostal]) ? $data[cp] : $data[codigoPostal], 0, 0, 'L');
